    ...
    public class Backgrounds
    {
        ...
        private class BackgroundTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if( m_Setting )
				{
					target.osu_char_info.Backgrounds.BackgroundDictionary[m_Background].Level = m_Level;
					from.SendMessage( "Property has been set." );
				}
				
				else
					from.SendMessage( m_Background.ToString() + " = " + target.osu_char_info.Backgrounds.BackgroundDictionary[m_Background].Level.ToString() );
			}
        }
